...
/*
Remark: We can actually also use DFS to solve this problem. The key is to pass on the "rooms[x][y] + 1 < rooms[nx][ny]" information during each DFS recursion call:
*/
